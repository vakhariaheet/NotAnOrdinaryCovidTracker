...
export default function CountryData({
  ...
  return (
    <div className="countrydata">
      <h1 className="countrydata__heading">
        {finalSelectedCountry ? finalSelectedCountry : "Country"}
      </h1>
      <div className="countrydata__critical countrydata__item">
        <svg
          className="countrydata__item_svg"
        ...
        <h2 className="countrydata__critical--text countrydata__item--text">
          Critical : {criticalCases > 0 ? criticalCases : "-"}
        </h2>
      </div>
      <div className="countrydata__confirmed countrydata__item">
        <svg
          className="countrydata__item_svg"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 384 512"
        ...
        <h2 className="countrydata__confirmed--text countrydata__item--text">
          Confirmed : {confirmedCases > 0 ? confirmedCases : "-"}
        </h2>
      </div>
      <div className="countrydata__recoverd countrydata__item">
        <svg
          className="countrydata__item_svg"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 640 512"
      ...
      <div className="countrydata__died countrydata__item">
        <svg
          className="countrydata__item_svg"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 640 512"
        ...
        <h2 className="countrydata__died--text countrydata__item--text">
